...
exports.approve_decline_franchise = function (request_data, response_data) {
    ...
    Setting.findOne({}).then(setting_detail => {
        ...
        if (store_page_type == 2) {
            Franchise.findOneAndUpdate({ _id: franchises_id }, { is_approved: true }, { new: true }).then(franchises => {
            ...
            Franchise.findOneAndUpdate({ _id: franchises_id }, { is_approved: false }, { new: true }).then(franchises => {
