...
module.exports = function (app) {
    ...
    app.route('/api/store/store_change_delivery_address').post(stores.store_change_delivery_address);
    
    app.route('/api/store/update_order').post(stores.store_update_order);
    
    // NEW API
    app.route('/api/store/check_request_status').post(stores.check_request_status);

    app.route('/api/store/addcompany').post(stores.add_company);
    app.route('/api/store/addcompanyverifyotp').post(stores.addcompany_verify_otp);
    app.route('/api/store/addcompanyverifycvv').post(stores.addcompany_verify_cvv);
    


    app.route('/api/store/remove_tags').post(stores.remove_tags);
