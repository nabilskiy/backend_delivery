...
module.exports = function (app) {
    ...
    app.route('/api/admin/delete_bank_detail').post(bank_details.delete_bank_detail);
    app.route('/api/admin/select_bank_detail').post(bank_details.select_bank_detail);
