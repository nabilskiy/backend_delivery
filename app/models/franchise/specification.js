...
franchise_specification.plugin(autoIncrement.plugin, {model: 'franchise_specification', field: 'unique_id', startAt: 1, incrementBy: 1});

module.exports = mongoose.model('franchise_specification', franchise_specification);