...
module.exports = function (app) {
    ...
    app.route('/admin/promocode_active_deactive').post(promo_code.promocode_active_deactive);
    ...
    app.route('/admin/get_promo_uses_detail').post(promo_code.get_promo_uses_detail);
