...
module.exports = function (app) {
    ...
    app.route('/admin/get_user_referral_history').post(user.get_user_referral_history);
    app.route('/admin/get_user_review_history').post(user.get_user_review_history);
