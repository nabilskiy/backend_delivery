...
exports.generateReferralCode = function (user_type, country_code, first_name, last_name) {
    var referral_code = "";
    try {
        var length = 8;
...
exports.transfer_amount_to_employee = function (amount, account_id, currencycode, return_data) {
...
exports.check_zone = function (city_id, delivery_type, type_id, vehicle_id, zone_business, store_location, destination_location, car_calling, return_data) {
    if (!car_calling) {
        car_calling = false;
    }
                            ...
                            if (zonevalue && zonevalue.price >= 0) {
                                ...
                                if (!car_calling) {
                                    ...
                                    ZoneValue.find({ type_id: type_id }, function (err, zones) {
                                        ...
                                        if (zone_price_for_car_calling < 0) {
