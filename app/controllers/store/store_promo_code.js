...
exports.store_add_promo = function (request_data, response_data) {
    utils.check_request_params(request_data.body, [{name: 'promo_code_name', type: 'string'}], function (response) {
        if (response.success) {
...
exports.store_update_promo_code = function (request_data, response_data) {
    utils.check_request_params(request_data.body, [{name: 'promo_id', type: 'string'}], function (response) {
        if (response.success) {
            var request_data_body = request_data.body;
