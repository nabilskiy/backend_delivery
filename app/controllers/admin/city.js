        ...
        if (response.success) {
            ...
            Country.findOne({
                ...
                if (country_data)
                {
                    ...
                    City.find({ country_id: country_id, is_business: true }).then((city) => { //, {"city_name": 1,"city_nick_name":1}
                        if (city.length === 0) {
                            response_data.json({
                                success: false,
...
// test async version
// exports.get_city_list = async function (request_data, response_data) {
...
//                 {
//                     var country_id = country_data._id;
//                     const city = await City.find({ country_id: country_id, is_business: true })
//                         // .then((city) => { //, {"city_name": 1,"city_nick_name":1}
//                         if (city.length === 0) {
//                             const cities = await City.find({ country_id: "5faaf562e058c2047b7a76b2", is_business: true  });
//                             response_data.json({
//                                 success: false,
//                                 error_code: CITY_ERROR_CODE.CITY_DETAILS_NOT_FOUND,
//                                 country_phone_code: country_data.country_phone_code,
